...
![MyPhoto](/images/default_avatar.jpg)
© Rourou
...
A previous painful searching for high-quality research data urges me to start the [awesome-public-data community](https://github.com/APD-ORG). I reviewed hundreds of web pages, research papers, personal blogs and so on to make a tidy list of high-quality datasets in public domains. This community is activated since then. Hundreds of guys have contributed and helped to validate the items. Many thanks to them!

Now I get payed for a job of designing data platforms @transwarpio, China. I met many genius engineering guys here and learned more from them. I fabricated a new motto as inspired by them, "Learn more beyond what you can imagine." I love reading, traveling, and my family. I also program some [useful data analysis tools](http://xiaming.me/projects) in Python, Scala, and R. During spare time, Am working on the next iteration of APD and expecting a novel form of the power of data. If you interested in that, review my related [previous posts](http://xiaming.me/archives/).
