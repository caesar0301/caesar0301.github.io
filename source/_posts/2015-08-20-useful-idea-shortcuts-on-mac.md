...
IntelliJ is my excellent partner in programming and project review. I make up this list for daily referrence and share with community.
...
* Comment/Uncomment current line or selection: `CMD` + `/`  and  `* MD` + `Shift` + `/`
...
* Quick JavaDoc Popup to show the JavaDoc of the method or class at the text cursor: `Ctrl` + `J`
